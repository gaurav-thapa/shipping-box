...
const Navbar = () => {
    ...
    return (
        <div className=' sticky top-0 text-nowrap flex bg-gray-950 px-2 sm:px-4 sm:gap-6 items-center'>
            <div>
                <h1 className='cursor-default text-xl font-bold'>Shipping Box</h1>
